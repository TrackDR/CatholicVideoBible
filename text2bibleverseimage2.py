...
def writebiblejpg(basename,imgwidth,imgheight,lines,Book,Chapter,verses):
...
#bcvinput = "Is 63:16-17, 19; 64:2-7"
...
print(basename)
writebiblejpg(basename,imgwidth,imgheight,lines,Book,Chapter,verses)
